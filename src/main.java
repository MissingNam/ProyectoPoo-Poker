...
public class main {
    ...
    private static JTextField apuestaInicial = new JTextField("Ingrese la apuesta inicial");
    private static JTextField dineroInicial = new JTextField("Ingrese dinero inicial");
